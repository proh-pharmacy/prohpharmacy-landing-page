...
export function DeliveryDivider() {
  return (
    <div
      aria-hidden="true"
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="deliveryMintFade" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#ffffff" stopOpacity="0.2" />
            <stop offset="62%" stopColor="#f2fffb" stopOpacity="0.6" />
        ...
        <path
          ...
          fill="url(#deliveryMintFade)"
          opacity="0.65"
        />

        {/* Primary wave filled with the FAQ section background (#F0F7F3) */}
        <path
